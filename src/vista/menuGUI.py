...
"\n"
"QPushButton{\n"
"background-color: rgb(20, 54, 148);\n"
"text-align:center;\n"
...
"font: 75 28pt \"Century Gothic\";")
        ...
        self.lbl_icon.setMinimumSize(QSize(900, 100))
        self.lbl_icon.setMaximumSize(QSize(909, 400))
        self.lbl_icon.setLayoutDirection(Qt.LeftToRight)
        self.lbl_icon.setPixmap(QPixmap(u":/newPrefix/Iconos/wall.jpg"))
...
"color: rgb(0, 0, 0);")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/newPrefix/Iconos/iconCheck.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Calcular.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/newPrefix/Iconos/iconRedo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Limpiar.setIcon(icon4)
...
"\n"
"QPushButton{\n"
"background-color: rgb(22, 86, 189);\n"
"text-align:left;\n"
"border-top-left-radius: 20px;\n"
"border-bottom-left-radius:20px;\n"
"border-top-right-radius: 20px;\n"
...
"}")
        ...
        icon5 = QIcon()
        icon5.addFile(u":/newPrefix/Iconos/E.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Me_Euler_2.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/newPrefix/Iconos/T.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Me_Tylor_2.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/newPrefix/Iconos/EM.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Me_EM_2.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/newPrefix/Iconos/RK.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_Me_Runge_2.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/newPrefix/Iconos/iconCerrar.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"")
        ...
        self.btn_Me_Euler_1.setIcon(icon5)
        ...
        self.btn_Me_Tylor_1.setIcon(icon6)
        ...
        self.btn_Me_EM_1.setIcon(icon7)
        ...
        self.btn_Me_Runge_1.setIcon(icon8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_21.setText(QCoreApplication.translate("MainWindow", u"ECUACIONES DIFERENCIALES", None))
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"________________________________________________", None))
        self.label_23.setText(QCoreApplication.translate("MainWindow", u"El programa es una aplicaci\u00f3n GUI dise\u00f1ada para resolver ecuaciones\n"
"\n"
" diferenciales usando varios m\u00e9todos num\u00e9ricos como Euler, Taylor\n"
"\n"
" y Runge-Kutta. Permite al usuario seleccionar el m\u00e9todo deseado,\n"
"\n"
" ingresar los par\u00e1metros necesarios, y calcular los resultados, \n"
"\n"
"mostrando estos en una tabla. Adem\u00e1s, incluye funcionalidades para\n"
"\n"
" limpiar los campos y la tabla al cambiar de p\u00e1gina o al presionar \n"
"\n"
"un bot\u00f3n espec\u00edfico.\n"
"", None))
        self.label_24.setText(QCoreApplication.translate("MainWindow", u"\u00a9j_8", None))
